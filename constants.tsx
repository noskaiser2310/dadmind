...
// Placeholder base64 data URLs for AI-generated images.
// In a real scenario, these would be longer strings from actual Gemini image generation.
const AI_GENERATED_DAD_CHILD_ILLUSTRATION = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAGQAAABkCAYAAABw4pVUAAAAaklEQVR42u3BMQEAAADCoPVPbQ0PoAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADeDcYqAAGGTR7VAAAAAElFTkSuQmCC"; // Example: 100x100 black square
const AI_GENERATED_ROBOT_AVATAR = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAYAAACM/rhtAAAAEUlEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="; // Example: 1x1 red pixel (very small)
const AI_GENERATED_EXPERT_AVATAR = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACgAAAAoCAYAAACM/rhtAAAAE0lEQVR42mNkYGA4gPEFZL0BCGgA+f8Ex4sAAAAASUVORK5CYII="; // Example: 1x1 blue pixel (very small)


export const DAD_CHILD_ILLUSTRATION_URL = AI_GENERATED_DAD_CHILD_ILLUSTRATION; 
export const ROBOT_AVATAR_URL = AI_GENERATED_ROBOT_AVATAR; 
export const USER_AVATAR_URL = "/assets/user-avatar.webp"; 
export const EXPERT_AVATAR_URL = AI_GENERATED_EXPERT_AVATAR; 
...
export const IconQuote: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" d="M6 3a3 3 0 00-3 3v6a3 3 0 003 3h2.586l-1.293 1.293a1 1 0 101.414 1.414L10.414 15H11a1 1 0 100-2H6V6h3a1 1 0 100-2H6zm10 0a3 3 0 00-3 3v6a3 3 0 003 3h2.586l-1.293 1.293a1 1 0 101.414 1.414L20.414 15H21a1 1 0 100-2h-5V6h3a1 1 0 100-2h-3z" clipRule="evenodd" />
  </svg>
);

export const IconComment: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}> {/* Adjusted strokeWidth to match IconHeart */}
...
// New Icon for resource suggestions (can be same as Lightbulb or a variant)
export const IconBulbOutline: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
